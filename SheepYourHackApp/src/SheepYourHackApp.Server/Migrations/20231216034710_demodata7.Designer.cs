...
namespace SheepYourHackApp.Server.Migrations
{
    ...
    [Migration("20231216034710_demodata7")]
    partial class demodata7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SheepYourHackApp.Server.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndDate = new DateTime(2023, 12, 19, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5083),
                            FeedId = 1,
                            Name = "EventA",
                            Organizator = "Google",
                            StartDate = new DateTime(2023, 12, 16, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5088),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            EndDate = new DateTime(2023, 12, 18, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5092),
                            FeedId = 2,
                            Name = "EventB",
                            Organizator = "Google",
                            StartDate = new DateTime(2023, 12, 16, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5099),
                            Type = 1
                        },
                        new
                        {
                            Id = 3,
                            EndDate = new DateTime(2023, 12, 20, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5103),
                            FeedId = 3,
                            Name = "EventC",
                            Organizator = "Google",
                            StartDate = new DateTime(2023, 12, 16, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5105),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("SheepYourHackApp.Server.Models.Feed", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 12, 16, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(4926),
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2023, 12, 15, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(4985),
                            Message = "Free webinar about something",
                            Type = 1,
                            UserId = 5
                        },
                        ...
                        {
                            Id = 3,
                            CreationDate = new DateTime(2023, 12, 4, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(4991),
                            Message = "Free webinar about something",
                            Type = 1,
                            UserId = 5
                        },
                        ...
                        {
                            Id = 4,
                            CreationDate = new DateTime(2023, 11, 25, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5010),
                            Message = "Free webinar about something",
                            Type = 0,
                            UserId = 5
                        },
                        ...
                        {
                            Id = 5,
                            CreationDate = new DateTime(2023, 12, 13, 4, 47, 10, 5, DateTimeKind.Local).AddTicks(5014),
                            Message = "Free webinar about something",
                            Type = 0,
                            UserId = 5
                        });
